---
name: theo-hayami
description: 「影の図書館」──図書館に迷い込んだゲーム画面のような没入。汎用UI chromeを禁じ、半透明ガラス板＋真鍮/金の細線＋明朝で組む文学・静謐トーン。osaka-kenpo の兄弟（懐旧の紙・蝋燭の金）。
colors:
...
theo-hayami の見た目の一言は **「影の図書館」**。Webページに見せず、「図書館に迷い込んだゲーム画面」の没入感を狙う。osaka-kenpo の兄弟だが、文学・静謐トーン（懐旧の紙・蝋燭の金）に振る。
