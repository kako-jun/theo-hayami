...
export const teaTimeQuestions: TeaTimeQuestion[] = [
  ...
  { slug: "partner-past", title: "恋人の過去の不倫", question: "付き合っている恋人が、過去に不倫をしたことがあると正直に打ち明けてきました。問いただすと、相手は私も知っている人で、誰かは知らないほうがいい、どうしても知りたいなら言う、と言われました。それから胃が痛み、周りの全員が疑わしく見えます。知らないままでいるのは無理で、中途半端が一番苦しい。恋人はひどいと思うのに、正直さでまだ付き合っていたい。私はきっと誰かを聞くでしょう。恋人とは縁を切らず、その相手とは二度と接点を持ちようがない世界にいきたい。どうすればよいでしょうか。" },
  ...
  { slug: "long-running-boredom", title: "面白くない長期連載", question: "周りやテレビが面白いと言う長期連載の漫画やドラマが、私には全く面白く感じられません。短く駆け抜ける作品は面白いのに。引き伸ばして続ける商業主義と、作家性のために短く終える作り手の二種類がいるのでしょうか。売れているのは本当でしょうが、周りに全巻持っている人はいないし、雑誌の部数も減っています。それが昔の名作と対等と言われるとむかつきます。この気持ちをどう整理すればいいでしょうか。" },
];
